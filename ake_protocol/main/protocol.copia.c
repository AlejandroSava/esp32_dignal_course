...
void app_main(void) 
{
    ...
    ESP_LOGW(TAG_PROT, "Free heap RoT: %u", (unsigned)esp_get_free_heap_size());
    ...
    get_puf_obj_from_puf(puf_obj, false); /*TODO: CHANGE TO TRUE AFTER PROVISIONING */
    ...
    printf("Tiempo de ejecución STEP 0: %lld us\n", (end - start));
    ...
    printf("Tiempo de ejecución STEP 1: %lld us\n", (end - start));
    ...
    printf("Tiempo de ejecución STEP 2: %lld us\n", (end - start));
    ...
    printf("Tiempo de ejecución secure channel %lld us\n", (end - start));
